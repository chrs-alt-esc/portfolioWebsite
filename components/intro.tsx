...
export default function Intro() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="mb-28 max-w-[50rem] text-center sm:mb-8 scroll-mt-[100rem]"
    >
      ...
      >
        Hi, I'm <span className="font-bold">{`Chris Escobar`}</span>! I'm a{" "}
        <span className="font-bold">{`software developer`}</span> with{" "}
        <span className="font-bold">{`3 years`}</span> of experience. I enjoy
        building <span className="italic">{`applications and websites`}</span>.
        My focus is{" "}
      ...
      >
        ...
        >
          Contact me here{" "}
          <BsArrowRight className="opacity-70 group-hover:translate-x-1 transition dark:opacity-100" />
        </Link>
        <a
        ...
        <div className="flex sm:flex-row justify-center items-center sm:gap-6 px-7 sm:px-0">
          ...
          <a
            ...
            href="https://github.com/chrs-alt-esc"
            target="_blank"
          >
            <FaGithubSquare />
          </a>
